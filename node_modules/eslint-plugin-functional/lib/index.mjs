...
function createRuleUsingFunction(name, meta, defaultOptions, createFunction) {
    return ESLintUtils.RuleCreator((ruleName) => `https://github.com/eslint-functional/eslint-plugin-functional/blob/v4.4.1/docs/rules/${ruleName}.md`)({
        name,
        meta,
        defaultOptions,
...
const schema$f = [
    {
        type: "object",
        properties: deepmerge(ignorePatternOptionSchema, ignorePrefixSelectorOptionSchema, {
            allowRestParameter: {
                type: "boolean",
            },
